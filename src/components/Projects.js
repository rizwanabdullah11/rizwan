...
const projects = [
  {
    ...
    image: VRHub,
    github: "https://vr-hub-site.netlify.app/",
  },
  {
    id: 2,
    name: "Eflyer",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            ...
            transform transition-transform duration-300 hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-center mb-2">{project.name}</h3>
              <p className="text-gray-400 text-center mb-4">{project.technologies}</p>
              <div className="flex justify-center">
                <a
                  href={project.github}
                  className="inline-block bg-gradient-to-r from-purple-800 to-purple-400 text-white px-4 py-2 rounded-full pl-10 pr-10"
                  target="_blank"
